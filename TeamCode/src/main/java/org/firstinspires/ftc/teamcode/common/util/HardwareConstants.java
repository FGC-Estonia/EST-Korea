...
public class HardwareConstants {
    ...
    // Movement motors
    public static final String LEFT_FRONT_MOTOR = "Motor_Port_2_EH";
    public static final String RIGHT_FRONT_MOTOR = "Motor_Port_3_EH";
    public static final String LEFT_BACK_MOTOR = "Motor_Port_1_EH";

    public static final String RIGHT_BACK_MOTOR = "Motor_Port_0_EH";
    // Rope motors
    public static final String ROPE_MOTOR = "Motor_Port_2_CH";
    ...
    public static final String BALL_COLLECTOR_MOTOR = "Motor_Port_3_CH";
    public static final String FEEDER_MOTOR = "Motor_Port_1_CH";
